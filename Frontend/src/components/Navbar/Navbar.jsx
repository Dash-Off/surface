...
const Navbar = () => {
  ...
  return (
    <div  ref={navbarRef} >
        ...
        <div className='navbar-list flex justify-between relative'>
            <div className='flex h-10 items-center'>  
                <FaLayerGroup className="text-5xl p-2"/>    
                <FaRobot className="text-5xl p-2"/>
                <h3 className="text-3xl p-2">dash<strong>Off</strong></h3>
            </div>
        ...
        <div  className={`bg-slate-50 absolute border shadow-sm w-52 top-10.5 right-2 rounded-2xl ${!navbarDropdown && 'hidden'}  z-10`}>
            <ul>
        ...
        <div ref = {languageListRef} className={`language-list bg-slate-50 absolute border shadow-sm w-52 top-10 right-10 mt-12 mr-44 rounded-2xl transition-opacity ease-in-out duration-500  
