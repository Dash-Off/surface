...
const Assistant = () => {
  ...
  return (
    <div>
      <div
        className={`ml-10 bg-slate-50 h-screen pt-8 ${open ? "w-[700px]" : "w-30"} transition-all duration-1600 `}
      >
        <div className="flex ">
          <BsArrowRightShort
            className={`relative right-3 bg-white text-dark-purple text-3xl 
          ...
          <p
            className={`${open && "hidden"} mr-2 border-2 w-20 rounded-3xl text-center`}
          >
            00/100
          </p>
        </div>
        ...
        <div
          className={`${!open && "hidden scale-0"} flex mt-2 border-t-2 justify`}
        >
          <button
            key="1"
            ...
            onClick={() => {
              setAllSelected(true);
              setGrammarSelected(false);
              setRecommendationsSelected(false);
            }}
          >
            All
          ...
          <button
            ...
            onClick={() => {
              setAllSelected(false);
              setGrammarSelected(false);
              setRecommendationsSelected(true);
            }}
          >
            Recommendations
        ...
        <div
          className={`m-5 p-5 border-[2px] shadow-lg rounded-lg ${!open && "hidden scale-0"} `}
        >
          ...
          <p className="mt-2">
            ...
            adipisicing elit. Nemo quis libero quasi saepe ipsa ut pariatur est
            recusandae. Est saepe corrupti,{" "}
            <strong className="text-red-600">maxime ipsam </strong>mollitia
            atque neque <span className="line-through">similique natus</span>{" "}
            ducimus architecto.
          </p>
