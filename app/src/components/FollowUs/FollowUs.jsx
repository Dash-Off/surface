...
// Import the image
import WritingOnDeskImage from 'C:/Users/enigm/OneDrive/Documents/PortfolioProjects/DashOff/Frontend/src/assets/WritingOnDesk.webp';
  ...
  return (
    <div className=' bg-followUs-background h-[500px] bg-no-repeat w-full bg-cover'>
        <div className='flex justify-between'>
            ...
            <div className='ml-32'>
                <img className='h-[500px] opacity-30 rounded-full' src={WritingOnDeskImage} alt="Not Here" />
            </div>
            ...
            <div className='grid grid-cols-1 mr-56 mt-14'>
                <div className='flex m-5'>
                    ...
                    <div className='w-[400px] ml-5'>
                        ...
                        <p className='text-xl'> Lorem ipsum dolor sit amet, cont nostrum quis officia harum temporibus assumenda a?</p>
                    </div>
                </div>
